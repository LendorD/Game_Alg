...
import copy
import pygame
from defs.constants import MAP_WIDTH, MAP_HEIGHT, NUM_GENERATIONS, POPULATION_SIZE, MUTATION_RATE, WALL, EMPTY, FOOD, POISON, MOB, MOB_ENERGY
from defs.classes import Mob, Wall, Poison, Food
